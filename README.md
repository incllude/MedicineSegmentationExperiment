...
Как видно из таблицы, даже при небольших углах поворота $[0^\circ, 1^\circ]$ может быть потеря информации. С увеличением угла поворота потеря информации возрастает, что отражается в увеличении MAPE для изображений и уменьшении Dice для карт классов. Тем не менее, даже при больших поворотах $[45^\circ, 180^\circ]$ в среднем потеря информации остается на удобоваримом уровне, поэтому можно говорить о корректности применяемого метода поворота изображений.
