...
| -------- | -------------- | ------------ | --------------------------- | ------------ | ----------------------- | -------------------- | ------------ | -------------------- | ------------------------ | ------------- |
| Оригинальные изображения | — | 0.774 | 0.032 | 0.724 | 0.724 | 0.757 | 0.771 | 0.795 | 0.823 | 0.823 |
| Оригинальные изображения с рамкой | — | 0.799 | 0.019 | 0.762 | 0.775 | 0.794 | 0.802 | 0.807 | 0.824 | 0.824 |
| Эксперимент 1 | $[0^\circ, 1^\circ]$ | 0.774 | 0.028 | 0.711 | 0.711 | 0.757 | 0.777 | 0.792 | 0.824 | 0.824 |
| Эксперимент 2 | $[1^\circ, 5^\circ]$ | 0.735 | 0.037 | 0.638 | 0.638 | 0.709 | 0.742 | 0.761 | 0.817 | 0.817 |
| Эксперимент 3 | $[5^\circ, 20^\circ]$ | 0.69 | 0.035 | 0.58 | 0.606 | 0.671 | 0.696 | 0.715 | 0.781 | 0.781 |
| Эксперимент 4 | $[20^\circ, 45^\circ]$ | 0.614 | 0.066 | 0.41 | 0.436 | 0.573 | 0.623 | 0.664 | 0.75 | 0.75 |
...
| -------- | -------------- | ----------- | -------------------------- | ----------- | ---------------------- | ------------------- | ----------- | ------------------- | ----------------------- | ------------ |
| Оригинальные изображения | — | 0.651 | 0.038 | 0.594 | 0.594 | 0.636 | 0.64 | 0.673 | 0.712 | 0.712 |
...
| Эксперимент 2 | $[1^\circ, 5^\circ]$ | 0.598 | 0.042 | 0.494 | 0.494 | 0.568 | 0.602 | 0.626 | 0.702 | 0.702 |
| Эксперимент 3 | $[5^\circ, 20^\circ]$ | 0.549 | 0.036 | 0.44 | 0.466 | 0.53 | 0.556 | 0.573 | 0.637 | 0.66 |
| Эксперимент 4 | $[20^\circ, 45^\circ]$ | 0.476 | 0.062 | 0.286 | 0.307 | 0.437 | 0.482 | 0.523 | 0.614 | 0.614 |
...
| -------- | -------------- | ----------------- | -------------------------------- | ----------------- | ---------------------------- | ------------------------- | ----------------- | ------------------------- | ----------------------------- | ------------------ |
| Оригинальные изображения | — | 0.818 | 0.079 | 0.719 | 0.719 | 0.742 | 0.828 | 0.891 | 0.907 | 0.907 |
| Оригинальные изображения с рамкой | — | 0.868 | 0.063 | 0.772 | 0.772 | 0.819 | 0.883 | 0.918 | 0.945 | 0.945 |
| Эксперимент 1 | $[0^\circ, 1^\circ]$ | 0.802 | 0.087 | 0.641 | 0.641 | 0.732 | 0.795 | 0.873 | 0.945 | 0.945 |
| Эксперимент 2 | $[1^\circ, 5^\circ]$ | 0.715 | 0.088 | 0.574 | 0.574 | 0.643 | 0.698 | 0.766 | 0.936 | 0.936 |
| Эксперимент 3 | $[5^\circ, 20^\circ]$ | 0.684 | 0.072 | 0.57 | 0.57 | 0.623 | 0.673 | 0.728 | 0.887 | 0.905 |
| Эксперимент 4 | $[20^\circ, 45^\circ]$ | 0.658 | 0.092 | 0.449 | 0.449 | 0.588 | 0.649 | 0.713 | 0.864 | 0.864 |
| Эксперимент 5 | $[45^\circ, 180^\circ]$ | 0.513 | 0.127 | 0.267 | 0.267 | 0.407 | 0.498 | 0.609 | 0.852 | 0.852 |
...
| Эксперимент 3 | $[5^\circ, 20^\circ]$ | 0.886 | 0.025 | 0.765 | 0.845 | 0.878 | 0.891 | 0.899 | 0.926 | 0.926 |
| Эксперимент 4 | $[20^\circ, 45^\circ]$ | 0.834 | 0.051 | 0.637 | 0.711 | 0.807 | 0.846 | 0.872 | 0.916 | 0.916 |
| Эксперимент 5 | $[45^\circ, 180^\circ]$ | 0.627 | 0.11 | 0.325 | 0.351 | 0.562 | 0.626 | 0.702 | 0.896 | 0.896 |
...
На графиках видно, что минимальные значения метрик снижаются значительно сильнее по сравнению с максимальными, при этом максимальные значения в большинстве случаев остаются на высоком уровне. Ниже представлена таблица, демонстрирующая сравнительное снижение минимальных и максимальных значений метрик в экспериментах. Здесь ***% от минимального значения*** указывает на отношение минимального значения метрики в 5-м эксперименте со сверхбольшими углами поворота к минимальному значению в 1-м эксперименте с очень малыми углами поворота, а ***% от максимального значения*** — отношение максимальных значений метрик в этих экспериментах.

| Метрика | % от минимального значения | % от максимального значения |
| ------- | -------------------------- | --------------------------- |
| Dice | 0.128 | 0.819 |
| IoU | 0.089 | 0.746 |
| Precision | 0.346 | 0.902 |
| Recall | 0.361 | 0.953 |
