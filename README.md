...
Результаты экспериментов подтверждают влияние угла поворота 3D КТ-снимков на качество сегментации, что согласуется с выдвинутой гипотезой. Все метрики (минимум, максимум, среднее и т.п.), последовательно снижаются с увеличением угла поворота. Precision резко падает: при малых углах верхние значения остаются выше 0.9, однако 25-й и 75-й перцентили значительно снижаются. Recall показывает иную тенденцию: при несильном снижении 25ого и 75ого перцентилей, нижняя граница уса и выбросы значительно падают. Визуальный осмотр выявил, что даже при малых углах поворота модель может не сегментировать некоторые объекты (срез 256 во 2-м эксперименте, срезы 286 и 260 в 3-м), а также неправильно сегментировать части органов (срез 218 во 2-м, срезы 286 и 260 в 3-м экспериментах). Эти тенденции видны и в 1-м эксперименте при очень малых углах поворота, но выражены слабее.
